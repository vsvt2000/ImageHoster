    ...
    return (
        <div class="flex items-center justify-center h-screen bg-slate-600 text-center">
            <div>
                ...
                <button type="submit" id="submit" value="Login" class="text-white bg-blue-700 m-1 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">{buttonText}</button>
            </div>
        </div>
    );
}